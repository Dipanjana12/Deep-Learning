import numpy as np
from Helper_Function import mean
...
class SVMDecisionTreeNode:
    ...
    def _dim_split_aux(self, split_tuples, split_vals, new_id, split_depth):
        ...
        split_tuples = deepcopy(
            split_tuples)  # else they're all popping from the same place and run out of dimensions to split, not to mention split asymmetrically!
